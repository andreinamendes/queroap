...
Para  mais detalhes sobre o projeto fica a disposição o [Documento de Visão](https://github.com/andreinamendes/queroap/blob/main/Documento%20de%20Visão.docx.pdf), contendo a descrição da problemática, personas, requisitos e etc.
